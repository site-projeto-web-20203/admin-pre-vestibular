...
<div class="container" align="center">
    ...
    <br>
    <h1 align="center">Editar Administrador</h1>
    <br>
    <form method="POST" action="{{url('/editar/administrador/'.$administrador->id)}}">
        ...
        <div class="container pt-3" align="left">
            ...
            <div class="col">
                ...
                <input id="password" type="text" value="{{$administrador->password}}" class="form-control @error('password') is-invalid @enderror" name="password" required autofocus/>
                @error('password')
                <span class="invalid-feedback" role="alert">
                              <strong>{{$message}}</strong>
                            </span>
